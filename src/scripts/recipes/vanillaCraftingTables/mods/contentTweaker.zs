...
static mirroredRecipes as IIngredient[][][][IItemStack] = {	
    <contenttweaker:container:0>: [
        [
            [<thaumcraft:cluster:5>, <minecraft:iron_trapdoor:0>, <thaumcraft:cluster:5>],
            [<thaumcraft:cluster:5>, null, <thaumcraft:cluster:5>],
            [<thaumcraft:cluster:5>, <thaumcraft:cluster:5>, <thaumcraft:cluster:5>]
        ]
    ],
};
