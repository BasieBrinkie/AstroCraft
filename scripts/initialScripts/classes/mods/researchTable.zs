...
zenClass researchTable {
          ...
          for description, array3 in array2 {
            for requiredStage, rewardStage in array3 {
              ...
              ResearchTable.builder("research " ~ name, category)
                ...
                .setTitle(name)
                .setDescription(description)
                .setRewardCommands("/say @s toggled '" ~ name ~ " '", "/gamestage remove @p " ~ requiredStage)
                .setNoMaxCount()
                .setRequiredStages(requiredStage)
  ...
  function addResearch(map as string[][]) {
    ...
    ResearchTable.builder("researchKitchenSink", category)
      ...
      .setRewardCommands("/say @s unlocked the research for kitchen-sink mode")
