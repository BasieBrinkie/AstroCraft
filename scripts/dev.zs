...
global devAddRecipes as bool = true; 		//This setting will prevent new recipes from being added if TRUE
...
global devNonStagedItems as bool = false;	//This setting add all non staged items to a stage if TRUE, might up the loading time drastically